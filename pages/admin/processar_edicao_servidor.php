...
// 5. REDIRECIONAMENTO DINÂMICO (CORRIGIDO)
$setor_logado = $_SESSION['usuario']['setor_admin'];

// Define o caminho relativo a partir da raiz do site
$path = ($setor_logado === 'CAD') ? '/pages/admin_cad/dashboard_cad.php' : '/pages/admin_coen/dashboard_coen.php';

// Usa a constante BASE_URL (definida em config.php) para criar um URL completo e absoluto.
// Isso evita problemas com caminhos relativos e reescrita de URL.
