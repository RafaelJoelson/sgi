...
define('ASSET_VERSION', '2.4'); // Atualize essa versão quando fizer alterações significativas
define('HORARIO_FUNC_INICIO', 9); // Horário de funcionamento da reprografia
