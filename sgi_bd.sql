...
('2025000010', 'Tulla', 'Luana', 'Nenhum', 'tulla.luana.topzera@email.com', '90123456780', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 10, '2025-07-30'),
...
('1000003', 'Paulo', 'Freire', 'paulo.freire@if.edu', '67890123456', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000004', 'Anísio', 'Teixeira', 'anisio.teixeira@if.edu', '78901234567', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000005', 'Darcy', 'Ribeiro', 'darcy.ribeiro@if.edu', '89012345678', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000006', 'Milton', 'Santos', 'milton.santos@if.edu', '90123456789', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000007', 'Florestan', 'Fernandes', 'florestan.fernandes@if.edu', '91234567890', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000008', 'Celso', 'Furtado', 'celso.furtado@if.edu', '92345678901', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000009', 'Fernanda', 'Wanderley', 'fernanda.wanderley@if.edu', '93456789012', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000010', 'Gilberto', 'Freyre', 'gilberto.freyre@if.edu', '94567890123', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000011', 'Maria', 'Montessori', 'maria.montessori@if.edu', '95678901234', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000012', 'Emília', 'Ferreiro', 'emilia.ferreiro@if.edu', '96789012345', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000013', 'Leôncio', 'Buarque', 'leoncio.buarque@if.edu', '97890123456', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000014', 'José', 'Martins', 'jose.martins@if.edu', '98901234567', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000015', 'Angela', 'Davis', 'angela.davis@if.edu', '99012345678', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000016', 'Sérgio', 'Buci', 'sergio.buci@if.edu', '90123456780', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000017', 'Lélia', 'Gonzalez', 'lelia.gonzalez@if.edu', '91234567881', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000018', 'Caio', 'Prado', 'caio.prado@if.edu', '92345678902', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000019', 'Vera', 'Candau', 'vera.candau@if.edu', '93456789013', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000020', 'Roberto', 'Schwarz', 'roberto.schwarz@if.edu', '94567890124', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000021', 'Maria', 'Carneiro', 'maria.carneiro@if.edu', '95678901235', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000022', 'Octávio', 'Ianni', 'octavio.ianni@if.edu', '96789012346', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000023', 'Cecília', 'Meireles', 'cecilia.meireles@if.edu', '97890123457', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000024', 'Dermeval', 'Saviani', 'dermeval.saviani@if.edu', '98901234568', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL),
('1000025', 'Ana', 'Mae', 'ana.mae@if.edu', '99012345679', '$2y$10$17dOADFRPti.MK62Y.shK.8ph9JJEFiQVI33hW9wCCKaDaQgU9bJC', 0, 0, 'NENHUM', 1, NULL);
...
('1000004', 900, 100, 85, 15),
('1000005', 500, 500, 50, 50),
('1000006', 700, 300, 90, 10),
('1000007', 800, 200, 95, 5),
('1000008', 600, 400, 80, 20),
('1000009', 400, 600, 70, 30),
('1000010', 995, 5, 60, 40),
('1000011', 0, 1000, 0, 100),
('1000012', 300, 700, 0, 100),
('1000013', 0, 1200, 20, 80),
('1000014', 700, 300, 10, 90),
('1000015', 800, 200, 5, 95),
('1000016', 600, 400, 15, 85),
('1000017', 400, 600, 25, 75),
('1000018', 1000, 800, 100, 65),
('1000019', 100, 900, 0, 140),
('1000020', 0, 1000, 55, 45),
('1000021', 500, 500, 65, 35),
('1000022', 700, 300, 75, 25),
('1000023', 800, 200, 85, 15),
('1000024', 600, 400, 99, 1),
('1000025', 0, 1600, 98, 2);
...
(3, '89012345678', 'Servidor', 'oficio_joao.pdf', 3, 1, 0, 'Lida', '2025-07-10 12:00:00', 2),
(4, '98901234568', 'Servidor', 'relatorio_maria.pdf', 8, 2, 0, 'Aceita', '2025-07-01 09:00:00', 1),
(5, '98901234568', 'Servidor', 'oficio_maria.pdf', 4, 1, 1, 'Aceita', '2025-06-29 10:30:00', 2),
(6, '98901234567', 'Servidor', 'memorando_joao.pdf', 6, 3, 0, 'Aceita', '2025-05-30 14:00:00', 1),
...
(12, '89012345678', 'Servidor', 'documento_oficial.pdf', 2, 1, 1, 'Aceita', '2024-10-20 11:00:00', 1),
